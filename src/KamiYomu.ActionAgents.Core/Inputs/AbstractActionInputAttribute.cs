...
/// 
public abstract class AbstractActionInputAttribute : Attribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionTextAttribute"/> class.
    /// </summary>
    /// <param name="name">An identifier of the input.text field (e.g., "Username").</param>
    protected AbstractActionInputAttribute(string name, string legend)
    {
    ...
    protected AbstractActionInputAttribute(string name, string legend, bool required, string defaultValue)
        : this(name, legend)
    {
        Required = required;
    ...
    protected AbstractActionInputAttribute(string name, string legend, bool required, string defaultValue, short order)

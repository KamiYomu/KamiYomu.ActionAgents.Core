...
/// Each <see cref="ActionCheckBoxAttribute"/> defines a checkbox-driven setting or metadata flag
...
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="ActionCheckBoxAttribute"/> class, representing a configurable checkbox option
...
public class ActionCheckBoxAttribute(string name, string legend, string[] options) : AbstractActionInputAttribute(name, legend)
{

    /// <inheritdoc/>
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionCheckBoxAttribute"/> class.
    /// </summary>
    ...
    public ActionCheckBoxAttribute(string name, string legend, bool required, string defaultValue, string[] options)
    ...
    /// <param name="options">One or more  flags or identifiers associated with this option (e.g.,  "en", "pt" "fr").</param>
    /// <param name="defaultValue">Set the default value for this option</param>
    public ActionCheckBoxAttribute(string name, string legend, bool required, string defaultValue, short order, string[] options)
    ...
    /// </summary>
    public string[] Options { get; } = options?.Length > 0 ? options : throw new ArgumentException("Must contains items", nameof(options));


    /// <inheritdoc/>
    public override string ToString() => $"Order={Order} | Name=\"{Name}\" | Legend=\"{Legend}\" | Options=[{string.Join(", ", Options)}] | Required={Required} | Type=\"{nameof(ActionCheckBoxAttribute)}\"";
}

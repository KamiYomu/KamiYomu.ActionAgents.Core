...
/// Each <see cref="ActionCheckBoxAttribute"/> represents an input selector, runtime toggle,
...
public class ActionSelectAttribute : AbstractActionInputAttribute
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ActionSelectAttribute"/> class.
    /// </summary>
    ...
    public ActionSelectAttribute(string name, string legend, string[] options) : base(name, legend)
    {
    ...
    /// <param name="options">One or more  flags or identifiers associated with this option (e.g.,  "en", "pt" "fr").</param>
    public ActionSelectAttribute(string name, string legend, bool required, string[] options)
    ...
    /// <param name="options">One or more  flags or identifiers associated with this option (e.g.,  "en", "pt" "fr").</param>
    public ActionSelectAttribute(string name, string legend, bool required, short order, string[] options)
        : this(name, legend, required, options)
    {
        Required = required;
        Order = order;
    }
    ...
    /// <inheritdoc/>
    public override string ToString() => $"Order={Order} | Name=\"{Name}\" | Legend=\"{Legend}\" | Options=[{string.Join(", ", Options)}] | Required={Required} | Type=\"{nameof(ActionSelectAttribute)}\"";
}
